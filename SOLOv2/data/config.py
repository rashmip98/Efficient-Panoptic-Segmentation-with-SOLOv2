...
dataset_base = Config({
    ...
    'train_images': '/content/drive/MyDrive/mmdetection/data/cityscapes/leftImg8bit/train',
    'train_info': '/content/drive/MyDrive/mmdetection/data/cityscapes/annotations/instancesonly_filtered_gtFine_train.json',
    # Validation images and annotations.
    # 'valid_images': './data/coco/images/',
    # 'valid_info':   'path_to_annotation_file',
    'valid_images': '/content/drive/MyDrive/mmdetection/data/cityscapes/leftImg8bit/val',
    'valid_info': '/content/drive/MyDrive/mmdetection/data/cityscapes/annotations/instancesonly_filtered_gtFine_val.json',
...
coco2017_dataset = dataset_base.copy({
   'name': 'COCO 2017',
    ...
    'train_prefix': '/content/drive/MyDrive/mmdetection/data/cityscapes/leftImg8bit/train',
    'train_info': '/content/drive/MyDrive/mmdetection/data/cityscapes/annotations/instancesonly_filtered_gtFine_train.json',
    'trainimg_prefix': '',
    'train_images': '/content/drive/MyDrive/mmdetection/data/cityscapes/leftImg8bit/train',
    ...
    'valid_prefix': '/content/drive/MyDrive/mmdetection/data/cityscapes/leftImg8bit/val',
    'valid_info': '/content/drive/MyDrive/mmdetection/data/cityscapes/annotations/instancesonly_filtered_gtFine_val.json',
    'validimg_prefix': '',
    'valid_images': '/content/drive/MyDrive/mmdetection/data/cityscapes/leftImg8bit/val',
...
resnet34_backbone = backbone_base.copy({
    'name': 'resnet34',
    'path': '/content/drive/MyDrive/solo_new/pytorch_solov2/pretrained/resnet34_nofc.pth',
    'type': 'ResNetBackbone',
    'num_stages': 4,
    'frozen_stages': 1,
    'out_indices': (0, 1, 2, 3)
