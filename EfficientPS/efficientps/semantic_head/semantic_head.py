...
class LSFE(nn.Module):
    ...
    def __init__(self):
        ...
        self.abn_1 = nn.BatchNorm2d(128)#InPlaceABN(128)
        self.abn_2 = nn.BatchNorm2d(128)#InPlaceABN(128)
...
class DPC(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_first = DepthwiseSeparableConv(dilation=(1, 6),
                                                 padding=(1, 6),
                                                 **options)
        self.iabn_first = nn.BatchNorm2d(256)#InPlaceABN(256)
        # Branch 1
        self.conv_branch_1 = DepthwiseSeparableConv(padding=1,
                                                    **options)
        self.iabn_branch_1 = nn.BatchNorm2d(256)#InPlaceABN(256)
        # Branch 2
        self.conv_branch_2 = DepthwiseSeparableConv(dilation=(6, 21),
                                                    padding=(6, 21),
                                                    **options)
        self.iabn_branch_2 = nn.BatchNorm2d(256)#InPlaceABN(256)
        #Branch 3
        self.conv_branch_3 = DepthwiseSeparableConv(dilation=(18, 15),
                                                    padding=(18, 15),
                                                    **options)
        self.iabn_branch_3 = nn.BatchNorm2d(256)#InPlaceABN(256)
        # Branch 4
        self.conv_branch_4 = DepthwiseSeparableConv(dilation=(6, 3),
                                                    padding=(6, 3),
                                                    **options)
        self.iabn_branch_4 = nn.BatchNorm2d(256)#InPlaceABN(256)
        # Last conv
        ...
        self.iabn_last = nn.BatchNorm2d(128)#InPlaceABN(128)
