...
class TwoWayFpn(nn.Module):
    ...
    def __init__(self, in_feature_shape):
        ...
        print("fpn init", in_feature_shape)
    ...
    def forward(self, inputs):
        ...
        # print("reduction 2 ", b_up_x4.shape)
        ...
        # print("reduction 3 ", b_up_x8.shape)
        ...
        # print("reduction 4 ", b_up_x16.shape)
        ...
        # print("reduction 5 ", b_up_x32.shape)
